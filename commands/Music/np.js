...
class Np extends Command {
	...
	async run(message, args, data) {
		...
		const embed = new Discord.MessageEmbed()
			...
			.addField(message.translate("music/np:T_DURATION"), `${queue.formattedCurrentTime} / ${track.formattedDuration !== "00:00" ? track.formattedDuration : message.translate("music/play:LIVE")}`)
