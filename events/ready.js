...
module.exports = class {
	...
	async run() {
		...
		const status = [
			{ name: `${servers} ${client.getNoun(servers, client.translate("misc:NOUNS:SERVERS:1"), client.translate("misc:NOUNS:SERVERS:2"), client.translate("misc:NOUNS:SERVERS:5"))}`, type: "WATCHING" },
